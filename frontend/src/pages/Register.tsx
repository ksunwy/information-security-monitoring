                    ...
                    <div className="p-8 rounded-3xl border border-(--dark) backdrop-blur-xs bg-white/10 w-full">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-8.75">
                                <label className="block text-sm mb-1.5">Имя/Компания</label>
                                <input
                                    type="text"
                                    value={form.name}
                            ...
                            <div className="flex items-center gap-1 mb-7">
                                <input checked={agree} onChange={(e) => setAgree(e.target.checked)} type="checkbox" name="checkbox" id="checkbox" className='w-6 h-6 border border-(--dark) rounded-md bg-none' />
                                <span>Я принимаю условия <NavLink to="/policy"><u>соглашения</u></NavLink></span>
                            </div>
                            ...
                            <div className="relative overflow-hidden rounded-[10px]">
                                ...
                                <button
                                    ...
                                    className="relative w-full bg-(--white) druk text-(--dark) py-2 text-xl h-12.75 hover:bg-blue-100 disabled:opacity-50 rounded-[10px] [box-shadow:0px_26.2552px_46.7671px_rgba(9,14,34,0.25),inset_-13.1276px_1.64095px_21.3324px_#334E6C]"
                                >
                                    {isLoading ? 'Загрузка...' : 'Присоединиться'}
                                </button>
                            </div>
                            <span className='text-sm mt-4 flex w-full items-center justify-center'>Уже есть аккаунт?&nbsp;<NavLink to="/login"><u>Войти</u></NavLink></span>
                        </form>
                    </div>
                </div>
            </section>
