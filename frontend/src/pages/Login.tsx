    ...
    return (
        <>
            ...
            <section className="min-h-screen flex items-center justify-center relative md:overflow-auto overflow-hidden">
                ...
                <div className="flex flex-col items-center w-full max-w-[320px] md:max-w-168.25 gap-6 md:gap-12.5 relative">
                    ...
                    <div className="md:p-8 p-4 rounded-xl md:rounded-3xl border border-(--dark) backdrop-blur-xs bg-white/10 w-full">
                        {error && (
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-4 md:mb-8.75">
                                ...
                                <input
                                    ...
                                    className="w-full bg-none px-3.5 md:px-4.5 py-2 md:py-3 border border-(--dark) rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required
                                />
                            </div>
                            ...
                            <div className="relative overflow-hidden rounded-lg md:rounded-[10px]">
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full bg-(--white) druk text-(--dark) py-2 text-base md:text-xl h-10 md:h-12.75 hover:bg-blue-100 disabled:opacity-50 rounded-lg md:rounded-[10px] [box-shadow:0px_26.2552px_46.7671px_rgba(9,14,34,0.25),inset_-13.1276px_1.64095px_21.3324px_#334E6C]"
                                >
                                    {isLoading ? 'Вход...' : 'Войти'}
                                </button>
                            </div>
                            <span className='text-sm mt-4 md:flex-row flex-col flex w-full items-center justify-center'>Еще нет аккаунта?&nbsp;<NavLink to="/register"><u>Зарегистрироваться</u></NavLink></span>
                        </form>
                    </div>
                </div>
            </section>
